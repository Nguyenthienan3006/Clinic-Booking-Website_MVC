...
namespace Website_Mvc.Models
{
	public partial class Account
	{
		...
		public Account()
		{
			...
			PatientReviewsDoctorIdDoctorNavigations = new HashSet<PatientReviewsDoctor>();
			PatientReviewsDoctorIdPatientNavigations = new HashSet<PatientReviewsDoctor>();
		}
		...
		public virtual ICollection<PatientReviewsDoctor> PatientReviewsDoctorIdDoctorNavigations { get; set; }
		public virtual ICollection<PatientReviewsDoctor> PatientReviewsDoctorIdPatientNavigations { get; set; }
	}
}
